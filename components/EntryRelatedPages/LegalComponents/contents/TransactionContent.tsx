  ...
  return (
    <div>
      ...
      <Typography>
        ...
        Each time an Admin/Member Transaction (as defined below) is initiated on
        ...
        and{" "}
        <Link href="/legal?t=terms" underline="none" target="_blank">
          Terms and Conditions
        </Link>{" "}
        are hereby incorporated by reference with the same force and effect as
        though fully set forth herein. To the extent there is any inconsistency
        between the terms within those documents and these Transactions Terms,
        the Transaction Terms shall prevail solely in relation to the
        Admin/Member Transaction.
      </Typography>
      <Typography>
        <b>3. Parties:</b>
        The only parties to these Transaction Terms are the Admin and Member
        participating in the Admin/Member Transaction. Neither Skool.Com, Inc.,
      ...
      <Typography>
        ...
        parameters for pricing on Skool) the pricing applicable to the
        Admin/Member Transaction and the Content to which a Member may be given
        access.
      </Typography>
      <Typography>
        <b>c.</b> All prices appear in USD only.
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        then if the Member tries to make a Member Payment from the first card
        and the card is rejected for any reason, then the other payment card
        will be used to collect the full Member Payment.
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        remain payable to Admin. No refunds will be provided for partial billing
        periods, unless otherwise specifically stated in an applicable
        promotional offer. Upon cancellation, Member will retain access to
        Content through the end of the renewal period.
      </Typography>
      <Typography>
      ...
      <Typography>
        <b>7. Ownership of Content:</b> The Member participating in the
        Admin/Member Transaction acknowledges and agrees that the license of the
        Relevant Content provided in Section 6 of these Transaction Terms does
        not result in the Member acquiring any rights in or to the Relevant
        Content, which rights shall be retained by the Admin of the Relevant
        Content.
      </Typography>
      <Typography>
        <b>8. Expiry of License:</b> The license granted to a Member in relation
        to the Relevant Content will expire automatically without notice in the
        following circumstances:
      </Typography>
      <Typography>
        <b>a.</b> if the Member Payment related to the Admin/Member Transaction
        was unsuccessful, or is charged back or reversed for any reason;
      </Typography>
      <Typography>
        <b>b.</b> in respect of Subscriptions, at the end of the subscription
      ...
      <Typography>
        ...
        on circumstances. In most cases, Skool will not refund on behalf of
        Creators.
      </Typography>
      <Typography>
        <b>10. Obligations between Admin and Member:</b> In respect of every
        Admin/Member Transaction:
      </Typography>
      <Typography>
        <b>a.</b> the Admin and the Member participating in the Admin/Member
        Transaction agree to comply at all times with the Skool
        <Link underline="none" target="_blank" href="./legal?t=acceptable-use">
          {" "}
          Acceptable Use Policy
        </Link>{" "}
        in relation to the Relevant Content, including when accessing, viewing,
        and interacting with it;
      </Typography>
      <Typography>
        <b>b.</b> the Member participating in the Admin/Member Transaction
        agrees to make the Member Payment required to access, view, or interact
        with the Relevant Content, and agrees not to initiate a chargeback other
        than if the Member disputes the Admin/Member Transaction in good faith;
      </Typography>
      <Typography>
        <b>c.</b> the Admin participating in the Admin/Member Transaction agrees
        to make the Relevant Content available to the Member once the Member has
        made the Member Payment applicable to the Relevant Content;
      </Typography>
      <Typography>
        <b>d.</b>
        the Admin warrants that it possesses all necessary rights in and to the
        Relevant Content sufficient to license it to the Member in the territory
      ...
      <Typography>
        <b>e.</b>
        the Admin is solely responsible for creating and uploading the Relevant
        Content, and the Admin provides no guarantees that it will continue to
        create and upload Relevant Content on an ongoing basis; and
      </Typography>
      <Typography>
        <b>f.</b>
      ...
      <Typography>
        ...
        The Member participating in the Admin/Member Transaction acknowledges
        that Admins may add and remove Content at any time from their Admin
        community, and that Admins have the discretion to decide what sort of
        Content to make available on their community. In addition, the Member
        participating in the Admin/Member Transaction acknowledges that there
        may be circumstances where it is not possible for the Member to access
        the Relevant Content to be provided under the Admin/Member Transaction,
        including:
      </Typography>
      <Typography>
      ...
      <Typography>
        ...
        suspended or inaccessible; or
      </Typography>
      <Typography>
        <b>d.</b>
        if the Admin is unable to create or upload Relevant Content in the
        future.
      </Typography>
      <Typography>
        <b>12. Terms Relating to Disputes:</b>
        If there is a dispute between an Admin and a Member relating to an
        Admin/Member Transaction or these Transaction Terms, the Admin and
        Member agree that Skool.Com, Inc., is under no obligation to become
        involved and that we will not be held liable for any such dispute. We
        are not liable for the relationship between the Admin and the Member,
        and we will not provide legal advice regarding such matters.
      </Typography>
    </div>
  );
}
